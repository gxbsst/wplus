...
Refinery::Images.configure do |config|
  ...
  #config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"1024x680>"}
  ...
  # config.dragonfly_secret = "16137160fbe6115ac49de4d47cb0edffeb201fdf3904fd8d"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/weston/Projects/wplus/wineplus/public/system/refinery/images"
