...
module Refinery
  module ApiWines
    class ApiWine < Refinery::Core::BaseModel
      ...
      attr_accessible :type, :vintage, :name_en, :name_zh, :region, :wine_style, :capacity, :alcoholicity, :variety, :rating, :rating_rp, :rating_ws, :rating_jr, :price, :info, :cellar_num, :cellar_location, :slug, :image_id, :position, :wine_id, :sku
